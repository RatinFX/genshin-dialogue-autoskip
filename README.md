...
- a bit modified to my liking
- added extra pixel placements
- uses `pixelColorMatch()` instead of `pixel()` and use the `tolerance` property for them
- auto close Book / Reading dialogues via the ESC key
- continue through "black-screen + white-text + bottom yellow diamond" sections
